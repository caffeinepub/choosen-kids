...
import type { Artwork as _Artwork, ArtworkId as _ArtworkId, ArtworkStatus as _ArtworkStatus, ExternalBlob as _ExternalBlob, StudentProgress as _StudentProgress, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCourse(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCourse(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerCoursesProgress(): Promise<Array<StudentProgress> | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerCoursesProgress();
    ...
    async getCoursesByRegion(arg0: string): Promise<Array<Course>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoursesByRegion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHeritageRegions(): Promise<Array<HeritageRegion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHeritageRegions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVerifiedArtworks(): Promise<Array<Artwork>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVerifiedArtworks();
    ...
    async submitArtwork(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitArtwork(await to_candid_ExternalBlob_n20(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyArtwork(arg0: ArtworkId, arg1: ArtworkStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyArtwork(arg0, to_candid_ArtworkStatus_n21(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ArtworkStatus_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ArtworkStatus): ArtworkStatus {
    return from_candid_variant_n18(_uploadFile, _downloadFile, value);
}
async function from_candid_Artwork_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Artwork): Promise<Artwork> {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_StudentProgress>]): Array<StudentProgress> | null {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_ArtworkStatus_n17(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "verified" in value ? ArtworkStatus.verified : "pending" in value ? ArtworkStatus.pending : "rejected" in value ? ArtworkStatus.rejected : value;
}
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Artwork>): Promise<Array<Artwork>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Artwork_n15(_uploadFile, _downloadFile, x)));
}
function to_candid_ArtworkStatus_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ArtworkStatus): _ArtworkStatus {
...
function to_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ArtworkStatus): {
    verified: null;
} | {
    pending: null;
} | {
    ...
    return value == ArtworkStatus.verified ? {
        verified: null
    } : value == ArtworkStatus.pending ? {
        pending: null
